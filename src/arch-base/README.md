...
```json
{
  ...
  "image": "ghcr.io/zeritiq/arch-devcontainer-templates/arch-base:latest"
}
```
...
```json
{
  ...
  "features": {
    ...
    "ghcr.io/zeritiq/arch-devcontainer-features/yay:latest": {}
  }
}
```
...
```json
{
  "name": "Full Stack Arch Development",
  "image": "ghcr.io/zeritiq/arch-devcontainer-templates/arch-base:latest",
  "features": {
...
```dockerfile
FROM ghcr.io/zeritiq/arch-devcontainer-templates/arch-base:latest
